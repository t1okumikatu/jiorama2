...
def ContFSlow1():
    # 前進方向
    sendTWELite1(s, digital=[1, 0, 1, 0])
    time.sleep(0.1)
    # 前進低速
    sendTWELite1(s, analog=[0, -1, 50, -1])
    return
...
def ContFSlow2():
    # 前進方向
    sendTWELite2(s, digital=[1, 0, 1, 0])
    time.sleep(0.1)
    # 前進低速
    sendTWELite2(s, analog=[0, -1, 50, -1])
    return
...
def ContStop3():
    ...
    time.sleep(0.1)
    # 消灯
    sendTWELite3(s, digital=[1, 1, 1, 1])
    return
#4号車
